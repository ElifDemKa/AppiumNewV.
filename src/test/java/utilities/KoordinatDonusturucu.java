...
public class KoordinatDonusturucu {
    ...
    public static void main(String[] args) {
        ...
        // Yeni cihazın ekran boyutları
        int yeniCihazEkranGenislik = 1440; //pixel 7
        ...
        System.out.println("Yeni X Koordinatı: " + donusturulmusNokta.x); //1066
        System.out.println("Yeni Y Koordinatı: " + donusturulmusNokta.y);//1300
    }
